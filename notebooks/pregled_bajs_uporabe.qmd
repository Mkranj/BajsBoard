...
```{python}
# files aren't loaded in order, find the latest datetime
...
Na sljedećim grafikonima prikazan je pregled napučenosti izdvojenih postaja. Napučenost je 100% kada se na postaji nalazi broj bicikala jednak broju mjesta za bicikle. Ako su ostavljeni dodatni bicikli napučenost je preko 100%, a 0% označava da nije prisutan ni jedan bicikl na postaji.  
Obojene *kutije* na dijagramu označavaju da se 50% od svih opaženih stanja na pojedinoj postaji nalazi u tom rasponu, a crta unutar kocke označava medijan napučenosti postaje. Dodatne linije izvan kutije (engl. *whiskers*) označavaju veličinu raspona u kojemu se nalazi >99% opaženih stanja, uz eventualne ekstremne vrijednosti označene kružićima.  
