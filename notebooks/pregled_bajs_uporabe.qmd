...
# korištenjem smatramo ODLASKE sa stanica! Brojanje i dolazaka i odlazaka nam zapravo
...
Prelaskom preko svake postaje prikazuje se zabilježen broj korištenja bicikala i broj mjesta za bicikle. Klikom na postaju prikazuju se grafikoni s informacijama o prosječnom korištenju za svaki sat u danu i za svaki dan u tjednu.  
Korištenjem se smatra dolazak bicikla na ovu postaju s neke druge ("*Dolazni*" u grafikonu), kao i uzimanje bicikla s ove postaje ("*Odlazni*" u grafikonu).
